		...
		<div class="section section-breadcrumbs">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4">
						<img class="img-responsive img-thumbnail"  src="<?= base_url() ?>estilos/img/toc.jpg" alt="About Us">
					</div>
				</div>
			</div>
		</div>
	    	...
	    	<div class="container">
				<div class="row">
					<div class="col-sm-8 prueba1" style="border-radius:10px 10px 10px 10px;background-color: #ebebe0;color: #00283a;">
							<br><br>
							<P style="text-align: justify; font-size: 20px; line-height: 150%;"><?= $fila->descripcion ?></P><br><br>
							<a href="<?= base_url('public/img') . '/' . $fila->img ?>"><img class="zoom1" style="width: 100%; height: auto; " src="<?= base_url('public/img') . '/' . $fila->img ?>" alt="img04"></a><br><br>
							<h2>REQUISITOS</h2>
							<p style="text-align: justify; font-size: 20px; line-height: 150%;"><?= $prueba=nl2br($fila->requisitos)?></p>	
					</div>
					<?php
					}
					?>
					...
					<div class="col-sm-4">
										...
										<div class="widget-content" style="overflow: hidden; display: block;">
											...
											?>
												<li style="border-top: 0px; padding: 10px; border-bottom:1px rgba(0,0,0,.1) solid; display: list-item;">
													<a href="<?= base_url() ?>preguntas/inicio/index/<?= $fila->id ?>" style="text-decoration: none; color: #444; background: transparent;"><?= $fila->titulo ?></a>
												</li>
											<?php
											}
											?>
						...
						<img class="img-responsive" src="<?= base_url() ?>estilos/img/dudas2.jpg" alt="About Us">
					</div>
				</div>
			</div>
		</div>
